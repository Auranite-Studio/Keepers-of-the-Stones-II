...
public class PowerModItems {
	...
	public static final RegistryObject<Item> FREAKING_PARSNIP_SOUP = REGISTRY.register("freaking_parsnip_soup", () -> new FreakingParsnipSoupItem());
	public static final RegistryObject<Item> PLAGUE_ARMOR_HELMET = REGISTRY.register("plague_armor_helmet", () -> new PlagueArmorItem.Helmet());
	public static final RegistryObject<Item> PLAGUE_ARMOR_CHESTPLATE = REGISTRY.register("plague_armor_chestplate", () -> new PlagueArmorItem.Chestplate());
	public static final RegistryObject<Item> PLAGUE_ARMOR_LEGGINGS = REGISTRY.register("plague_armor_leggings", () -> new PlagueArmorItem.Leggings());
	public static final RegistryObject<Item> PLAGUE_ARMOR_BOOTS = REGISTRY.register("plague_armor_boots", () -> new PlagueArmorItem.Boots());
	public static final RegistryObject<Item> PLAGUE_BATTERY = REGISTRY.register("plague_battery", () -> new PlagueBatteryItem());
	public static final RegistryObject<Item> PLAGUE_WALKING_STICK = REGISTRY.register("plague_walking_stick", () -> new PlagueWalkingStickItem());
	public static final RegistryObject<Item> BLUE_FLAME_ARMOR_HELMET = REGISTRY.register("blue_flame_armor_helmet", () -> new BlueFlameArmorItem.Helmet());
	public static final RegistryObject<Item> BLUE_FLAME_ARMOR_CHESTPLATE = REGISTRY.register("blue_flame_armor_chestplate", () -> new BlueFlameArmorItem.Chestplate());
	public static final RegistryObject<Item> BLUE_FLAME_ARMOR_LEGGINGS = REGISTRY.register("blue_flame_armor_leggings", () -> new BlueFlameArmorItem.Leggings());
	public static final RegistryObject<Item> BLUE_FLAME_ARMOR_BOOTS = REGISTRY.register("blue_flame_armor_boots", () -> new BlueFlameArmorItem.Boots());
	public static final RegistryObject<Item> BLUE_FLAME_BATTERY = REGISTRY.register("blue_flame_battery", () -> new BlueFlameBatteryItem());
	public static final RegistryObject<Item> BLUE_MAGIC_FIREBALL = REGISTRY.register("blue_magic_fireball", () -> new BlueMagicFireballItem());
	public static final RegistryObject<Item> BLUE_FLAME_SWORD = REGISTRY.register("blue_flame_sword", () -> new BlueFlameSwordItem());
	public static final RegistryObject<Item> GRAVITY_ARMOR_HELMET = REGISTRY.register("gravity_armor_helmet", () -> new GravityArmorItem.Helmet());
	public static final RegistryObject<Item> GRAVITY_ARMOR_CHESTPLATE = REGISTRY.register("gravity_armor_chestplate", () -> new GravityArmorItem.Chestplate());
	public static final RegistryObject<Item> GRAVITY_ARMOR_LEGGINGS = REGISTRY.register("gravity_armor_leggings", () -> new GravityArmorItem.Leggings());
	...
	public static final RegistryObject<Item> SMOKE_MUSKET = REGISTRY.register("smoke_musket", () -> new SmokeMusketItem());
	public static final RegistryObject<Item> SPIRIT_ARMOR_HELMET = REGISTRY.register("spirit_armor_helmet", () -> new SpiritArmorItem.Helmet());
	public static final RegistryObject<Item> SPIRIT_ARMOR_CHESTPLATE = REGISTRY.register("spirit_armor_chestplate", () -> new SpiritArmorItem.Chestplate());
	public static final RegistryObject<Item> SPIRIT_ARMOR_LEGGINGS = REGISTRY.register("spirit_armor_leggings", () -> new SpiritArmorItem.Leggings());
	public static final RegistryObject<Item> SPIRIT_ARMOR_BOOTS = REGISTRY.register("spirit_armor_boots", () -> new SpiritArmorItem.Boots());
	public static final RegistryObject<Item> SPIRIT_BATTERY = REGISTRY.register("spirit_battery", () -> new SpiritBatteryItem());
	public static final RegistryObject<Item> SPIRIT_SICKLE = REGISTRY.register("spirit_sickle", () -> new SpiritSickleItem());
	public static final RegistryObject<Item> FORM_ARMOR_HELMET = REGISTRY.register("form_armor_helmet", () -> new FormArmorItem.Helmet());
	public static final RegistryObject<Item> FORM_ARMOR_CHESTPLATE = REGISTRY.register("form_armor_chestplate", () -> new FormArmorItem.Chestplate());
	public static final RegistryObject<Item> FORM_ARMOR_LEGGINGS = REGISTRY.register("form_armor_leggings", () -> new FormArmorItem.Leggings());
	public static final RegistryObject<Item> FORM_ARMOR_BOOTS = REGISTRY.register("form_armor_boots", () -> new FormArmorItem.Boots());
	public static final RegistryObject<Item> FORM_BATTERY = REGISTRY.register("form_battery", () -> new FormBatteryItem());
	public static final RegistryObject<Item> FORM_SAI = REGISTRY.register("form_sai", () -> new FormSaiItem());
	public static final RegistryObject<Item> MIND_ARMOR_HELMET = REGISTRY.register("mind_armor_helmet", () -> new MindArmorItem.Helmet());
	public static final RegistryObject<Item> MIND_ARMOR_CHESTPLATE = REGISTRY.register("mind_armor_chestplate", () -> new MindArmorItem.Chestplate());
	public static final RegistryObject<Item> MIND_ARMOR_LEGGINGS = REGISTRY.register("mind_armor_leggings", () -> new MindArmorItem.Leggings());
	public static final RegistryObject<Item> MIND_ARMOR_BOOTS = REGISTRY.register("mind_armor_boots", () -> new MindArmorItem.Boots());
	public static final RegistryObject<Item> MIND_BATTERY = REGISTRY.register("mind_battery", () -> new MindBatteryItem());
	public static final RegistryObject<Item> MIND_EPEE = REGISTRY.register("mind_epee", () -> new MindEpeeItem());
	public static final RegistryObject<Item> GOLDEN_DUST_ARMOR_HELMET = REGISTRY.register("golden_dust_armor_helmet", () -> new GoldenDustArmorItem.Helmet());
	public static final RegistryObject<Item> GOLDEN_DUST_ARMOR_CHESTPLATE = REGISTRY.register("golden_dust_armor_chestplate", () -> new GoldenDustArmorItem.Chestplate());
	public static final RegistryObject<Item> GOLDEN_DUST_ARMOR_LEGGINGS = REGISTRY.register("golden_dust_armor_leggings", () -> new GoldenDustArmorItem.Leggings());
	public static final RegistryObject<Item> GOLDEN_DUST_ARMOR_BOOTS = REGISTRY.register("golden_dust_armor_boots", () -> new GoldenDustArmorItem.Boots());
	public static final RegistryObject<Item> GOLDEN_DUST_BATTERY = REGISTRY.register("golden_dust_battery", () -> new GoldenDustBatteryItem());
	public static final RegistryObject<Item> GOLDEN_DUST_STAFF = REGISTRY.register("golden_dust_staff", () -> new GoldenDustStaffItem());
	public static final RegistryObject<Item> DARKNESS_ARMOR_HELMET = REGISTRY.register("darkness_armor_helmet", () -> new DarknessArmorItem.Helmet());
	public static final RegistryObject<Item> DARKNESS_ARMOR_CHESTPLATE = REGISTRY.register("darkness_armor_chestplate", () -> new DarknessArmorItem.Chestplate());
	public static final RegistryObject<Item> DARKNESS_ARMOR_LEGGINGS = REGISTRY.register("darkness_armor_leggings", () -> new DarknessArmorItem.Leggings());
	public static final RegistryObject<Item> DARKNESS_ARMOR_BOOTS = REGISTRY.register("darkness_armor_boots", () -> new DarknessArmorItem.Boots());
	public static final RegistryObject<Item> DARKNESS_BATTERY = REGISTRY.register("darkness_battery", () -> new DarknessBatteryItem());
	public static final RegistryObject<Item> DARK_SWORD = REGISTRY.register("dark_sword", () -> new DarkSwordItem());
	public static final RegistryObject<Item> THIRST_ARMOR_HELMET = REGISTRY.register("thirst_armor_helmet", () -> new ThirstArmorItem.Helmet());
	public static final RegistryObject<Item> THIRST_ARMOR_CHESTPLATE = REGISTRY.register("thirst_armor_chestplate", () -> new ThirstArmorItem.Chestplate());
	public static final RegistryObject<Item> THIRST_ARMOR_LEGGINGS = REGISTRY.register("thirst_armor_leggings", () -> new ThirstArmorItem.Leggings());
	public static final RegistryObject<Item> THIRST_ARMOR_BOOTS = REGISTRY.register("thirst_armor_boots", () -> new ThirstArmorItem.Boots());
	public static final RegistryObject<Item> CHAOS_ARMOR_HELMET = REGISTRY.register("chaos_armor_helmet", () -> new ChaosArmorItem.Helmet());
	public static final RegistryObject<Item> CHAOS_ARMOR_CHESTPLATE = REGISTRY.register("chaos_armor_chestplate", () -> new ChaosArmorItem.Chestplate());
	public static final RegistryObject<Item> CHAOS_ARMOR_LEGGINGS = REGISTRY.register("chaos_armor_leggings", () -> new ChaosArmorItem.Leggings());
	public static final RegistryObject<Item> CHAOS_ARMOR_BOOTS = REGISTRY.register("chaos_armor_boots", () -> new ChaosArmorItem.Boots());
	public static final RegistryObject<Item> HORROR_ARMOR_HELMET = REGISTRY.register("horror_armor_helmet", () -> new HorrorArmorItem.Helmet());
	public static final RegistryObject<Item> HORROR_ARMOR_CHESTPLATE = REGISTRY.register("horror_armor_chestplate", () -> new HorrorArmorItem.Chestplate());
	public static final RegistryObject<Item> HORROR_ARMOR_LEGGINGS = REGISTRY.register("horror_armor_leggings", () -> new HorrorArmorItem.Leggings());
	public static final RegistryObject<Item> HORROR_ARMOR_BOOTS = REGISTRY.register("horror_armor_boots", () -> new HorrorArmorItem.Boots());
	public static final RegistryObject<Item> FILTH_ARMOR_HELMET = REGISTRY.register("filth_armor_helmet", () -> new FilthArmorItem.Helmet());
	...
	public static final RegistryObject<Item> EMPTY_CHARACTERISTICS_CARD = REGISTRY.register("empty_characteristics_card", () -> new EmptyCharacteristicsCardItem());
	public static final RegistryObject<Item> CHARACTERISTICS_CARD = REGISTRY.register("characteristics_card", () -> new CharacteristicsCardItem());
	...
	public static final RegistryObject<Item> CURSED_KNIGHT_SPAWN_EGG = REGISTRY.register("cursed_knight_spawn_egg", () -> new ForgeSpawnEggItem(PowerModEntities.CURSED_KNIGHT, -11447452, -9817013, new Item.Properties()));
	...
	public static final RegistryObject<Item> CURSED_SQUIRE_SPAWN_EGG = REGISTRY.register("cursed_squire_spawn_egg", () -> new ForgeSpawnEggItem(PowerModEntities.CURSED_SQUIRE, -11447452, -9817013, new Item.Properties()));
	...
	public static final RegistryObject<Item> KEEPERS_BOOK = REGISTRY.register("keepers_book", () -> new KeepersBookItem());
	public static final RegistryObject<Item> RUNE_CUTTER = block(PowerModBlocks.RUNE_CUTTER);
	public static final RegistryObject<Item> EXTRA_STAR_POINTS_RUNE_1 = REGISTRY.register("extra_star_points_rune_1", () -> new ExtraStarPointsRune1Item());
	public static final RegistryObject<Item> EXTRA_STAR_POINTS_RUNE_2 = REGISTRY.register("extra_star_points_rune_2", () -> new ExtraStarPointsRune2Item());
	public static final RegistryObject<Item> EXTRA_STAR_POINTS_RUNE_3 = REGISTRY.register("extra_star_points_rune_3", () -> new ExtraStarPointsRune3Item());
	public static final RegistryObject<Item> MUSIC_HOPE = REGISTRY.register("music_hope", () -> new MusicHopeItem());
