...
public class PowerModMenus {
	...
	public static final RegistryObject<MenuType<WheelAbilitiesSmokeMenu>> WHEEL_ABILITIES_SMOKE = REGISTRY.register("wheel_abilities_smoke", () -> IForgeMenuType.create(WheelAbilitiesSmokeMenu::new));
	public static final RegistryObject<MenuType<WheelAbilitiesSpiritMenu>> WHEEL_ABILITIES_SPIRIT = REGISTRY.register("wheel_abilities_spirit", () -> IForgeMenuType.create(WheelAbilitiesSpiritMenu::new));
	public static final RegistryObject<MenuType<WheelAbilitiesFormMenu>> WHEEL_ABILITIES_FORM = REGISTRY.register("wheel_abilities_form", () -> IForgeMenuType.create(WheelAbilitiesFormMenu::new));
	public static final RegistryObject<MenuType<WheelAbilitiesMindMenu>> WHEEL_ABILITIES_MIND = REGISTRY.register("wheel_abilities_mind", () -> IForgeMenuType.create(WheelAbilitiesMindMenu::new));
	...
	public static final RegistryObject<MenuType<WheelAbiltiesGoldenDustMenu>> WHEEL_ABILTIES_GOLDEN_DUST = REGISTRY.register("wheel_abilties_golden_dust", () -> IForgeMenuType.create(WheelAbiltiesGoldenDustMenu::new));
	public static final RegistryObject<MenuType<WheelAbilityDarknessMenu>> WHEEL_ABILITY_DARKNESS = REGISTRY.register("wheel_ability_darkness", () -> IForgeMenuType.create(WheelAbilityDarknessMenu::new));
	public static final RegistryObject<MenuType<CharacteristicsCardGUIMenu>> CHARACTERISTICS_CARD_GUI = REGISTRY.register("characteristics_card_gui", () -> IForgeMenuType.create(CharacteristicsCardGUIMenu::new));
}
