...
public class PowerModBlocks {
	...
	public static final DeferredBlock<Block> CURSED_VAULT = register("cursed_vault", CursedVaultBlock::new);
	...
	public static final DeferredBlock<Block> ENERGIUM_VAULT = register("energium_vault", EnergiumVaultBlock::new);
