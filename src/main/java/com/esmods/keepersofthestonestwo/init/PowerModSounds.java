...
public class PowerModSounds {
	...
	public static final RegistryObject<SoundEvent> RECORD_HOPE = REGISTRY.register("record.hope", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("power", "record.hope")));
}
