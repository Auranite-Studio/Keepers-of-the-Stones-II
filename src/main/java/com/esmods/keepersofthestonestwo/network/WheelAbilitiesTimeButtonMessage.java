...
public class WheelAbilitiesTimeButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesTimeButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesTimeButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesTimeButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesTimeButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesTimeButtonMessage.class, WheelAbilitiesTimeButtonMessage::buffer, WheelAbilitiesTimeButtonMessage::new, WheelAbilitiesTimeButtonMessage::handler);
	}
}
