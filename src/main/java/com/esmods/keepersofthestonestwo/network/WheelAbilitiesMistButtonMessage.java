...
import com.esmods.keepersofthestonestwo.procedures.Attack127Procedure;
import com.esmods.keepersofthestonestwo.procedures.Attack126Procedure;
import com.esmods.keepersofthestonestwo.procedures.Attack125Procedure;
...
public record WheelAbilitiesMistButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = WheelAbilitiesMistMenu.guistate;
