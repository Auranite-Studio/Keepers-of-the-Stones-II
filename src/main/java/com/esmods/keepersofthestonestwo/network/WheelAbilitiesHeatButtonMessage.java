...
import com.esmods.keepersofthestonestwo.procedures.Attack195Procedure;
import com.esmods.keepersofthestonestwo.procedures.Attack194Procedure;
import com.esmods.keepersofthestonestwo.procedures.Attack193Procedure;
...
public record WheelAbilitiesHeatButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 3) {
			...
			Attack193Procedure.execute(entity);
		}
		if (buttonID == 4) {

			Attack194Procedure.execute(entity);
		}
		if (buttonID == 5) {

			Attack195Procedure.execute(entity);
		}
		if (buttonID == 6) {
