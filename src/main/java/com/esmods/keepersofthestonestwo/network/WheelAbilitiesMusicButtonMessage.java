...
import com.esmods.keepersofthestonestwo.procedures.Attack155Procedure;
import com.esmods.keepersofthestonestwo.procedures.Attack154Procedure;
import com.esmods.keepersofthestonestwo.procedures.Attack153Procedure;
...
public record WheelAbilitiesMusicButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = WheelAbilitiesMusicMenu.guistate;
