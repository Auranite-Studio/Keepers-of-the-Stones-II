...
public class WheelAbilitiesSpiritButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesSpiritButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesSpiritButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesSpiritButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesSpiritButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesSpiritButtonMessage.class, WheelAbilitiesSpiritButtonMessage::buffer, WheelAbilitiesSpiritButtonMessage::new, WheelAbilitiesSpiritButtonMessage::handler);
	}
}
