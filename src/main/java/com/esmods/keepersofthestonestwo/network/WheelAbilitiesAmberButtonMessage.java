...
public record WheelAbilitiesAmberButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	}, (RegistryFriendlyByteBuf buffer) -> new WheelAbilitiesAmberButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt()));
	@Override
	public Type<WheelAbilitiesAmberButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final WheelAbilitiesAmberButtonMessage message, final IPayloadContext context) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = WheelAbilitiesAmberMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesAmberButtonMessage.TYPE, WheelAbilitiesAmberButtonMessage.STREAM_CODEC, WheelAbilitiesAmberButtonMessage::handleData);
	}
}
