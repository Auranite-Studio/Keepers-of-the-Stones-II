...
public class WheelAbilitiesMindButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesMindButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesMindButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesMindButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesMindButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesMindButtonMessage.class, WheelAbilitiesMindButtonMessage::buffer, WheelAbilitiesMindButtonMessage::new, WheelAbilitiesMindButtonMessage::handler);
	}
}
