...
public class WheelAbilitiesFormButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbilitiesFormButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbilitiesFormButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbilitiesFormButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbilitiesFormButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbilitiesFormButtonMessage.class, WheelAbilitiesFormButtonMessage::buffer, WheelAbilitiesFormButtonMessage::new, WheelAbilitiesFormButtonMessage::handler);
	}
}
