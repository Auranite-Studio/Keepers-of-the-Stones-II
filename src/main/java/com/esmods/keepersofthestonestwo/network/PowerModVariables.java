...
public class PowerModVariables {
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			if (!event.isWasDeath()) {
				...
				clone.start_fog = original.start_fog;
				...
				clone.is_render_fog = original.is_render_fog;
				...
				clone.end_fog = original.end_fog;
	...
	public static class PlayerVariables implements INBTSerializable<CompoundTag> {
		...
		public boolean is_render_fog = false;
		...
		public CompoundTag serializeNBT(HolderLookup.Provider lookupProvider) {
			...
			nbt.putDouble("start_fog", start_fog);
			...
			nbt.putBoolean("is_render_fog", is_render_fog);
		...
		public void deserializeNBT(HolderLookup.Provider lookupProvider, CompoundTag nbt) {
			...
			start_fog = nbt.getDouble("start_fog");
			...
			is_render_fog = nbt.getBoolean("is_render_fog");
