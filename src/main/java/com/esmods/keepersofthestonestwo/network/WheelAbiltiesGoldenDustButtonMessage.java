...
public class WheelAbiltiesGoldenDustButtonMessage {
	private final int buttonID, x, y, z;

	public WheelAbiltiesGoldenDustButtonMessage(FriendlyByteBuf buffer) {
	...
	public WheelAbiltiesGoldenDustButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WheelAbiltiesGoldenDustButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WheelAbiltiesGoldenDustButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PowerMod.addNetworkMessage(WheelAbiltiesGoldenDustButtonMessage.class, WheelAbiltiesGoldenDustButtonMessage::buffer, WheelAbiltiesGoldenDustButtonMessage::new, WheelAbiltiesGoldenDustButtonMessage::handler);
	}
}
