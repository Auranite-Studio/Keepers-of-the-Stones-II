...
public class ProtectionMobEffect extends MobEffect {
	...
	public boolean applyEffectTick(ServerLevel level, LivingEntity entity, int amplifier) {
		ActiveModProtectionProcedure.execute(level, entity.getX(), entity.getY(), entity.getZ(), entity);
	...
	public static void modifyItemComponents(ModifyDefaultComponentsEvent event) {
		...
		if (original != null) {
			...
			onConsumeEffects.add(new RemoveStatusEffectsConsumeEffect(PowerModMobEffects.PROTECTION));
