...
public class CursedLanternBlock extends Block implements SimpleWaterloggedBlock {
	...
	public CursedLanternBlock(BlockBehaviour.Properties properties) {
		super(properties.sound(SoundType.TUFF).strength(2.5f, 3f).lightLevel(s -> (new Object() {
	...
	public void onPlace(BlockState blockstate, Level world, BlockPos pos, BlockState oldState, boolean moving) {
		...
		CursedLanternAfterAddedProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
