...
public class WheelAbilitiesColorsScreen extends AbstractContainerScreen<WheelAbilitiesColorsMenu> {
	private final static HashMap<String, Object> guistate = WheelAbilitiesColorsMenu.guistate;
