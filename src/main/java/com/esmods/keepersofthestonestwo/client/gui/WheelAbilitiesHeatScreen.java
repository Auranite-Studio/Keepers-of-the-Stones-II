...
public class WheelAbilitiesHeatScreen extends AbstractContainerScreen<WheelAbilitiesHeatMenu> {
	private final static HashMap<String, Object> guistate = WheelAbilitiesHeatMenu.guistate;
