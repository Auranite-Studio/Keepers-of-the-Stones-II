...
public class WheelAbilitiesPlagueScreen extends AbstractContainerScreen<WheelAbilitiesPlagueMenu> {
	private final static HashMap<String, Object> guistate = WheelAbilitiesPlagueMenu.guistate;
