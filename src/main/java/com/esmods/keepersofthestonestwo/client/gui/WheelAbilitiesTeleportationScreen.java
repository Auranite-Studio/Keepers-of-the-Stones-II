...
public class WheelAbilitiesTeleportationScreen extends AbstractContainerScreen<WheelAbilitiesTeleportationMenu> {
	...
	public void init() {
		...
		imagebutton_creating_portals_blue = new ImageButton(this.leftPos + 72, this.topPos + 134, 23, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_creating_portals_blue.png"), 23, 92, e -> {
		...
		imagebutton_creating_portals_orange = new ImageButton(this.leftPos + 95, this.topPos + 134, 23, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_creating_portals_orange.png"), 23, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
		...
		imagebutton_checkpoint_create = new ImageButton(this.leftPos + 133, this.topPos + 73, 23, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_checkpoint_create.png"), 23, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
		...
		imagebutton_checkpoint_tp = new ImageButton(this.leftPos + 156, this.topPos + 73, 23, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_checkpoint_tp.png"), 23, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesTeleportationButtonMessage(9, x, y, z));
		...
		imagebutton_teleportation_grabs = new ImageButton(this.leftPos + 72, this.topPos + 12, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_teleportation_grabs.png"), 46, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesTeleportationButtonMessage(10, x, y, z));
