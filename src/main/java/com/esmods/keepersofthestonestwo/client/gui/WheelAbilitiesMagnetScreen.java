...
public class WheelAbilitiesMagnetScreen extends AbstractContainerScreen<WheelAbilitiesMagnetMenu> {
	private final static HashMap<String, Object> guistate = WheelAbilitiesMagnetMenu.guistate;
	...
	public void init() {
		...
		guistate.put("button:imagebutton_magnetic_field_wave", imagebutton_magnetic_field_wave);
		...
		guistate.put("button:imagebutton_negative_charge", imagebutton_negative_charge);
		...
		guistate.put("button:imagebutton_positive_charge", imagebutton_positive_charge);
