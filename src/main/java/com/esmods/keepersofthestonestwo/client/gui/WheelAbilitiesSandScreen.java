...
public class WheelAbilitiesSandScreen extends AbstractContainerScreen<WheelAbilitiesSandMenu> {
	private final static HashMap<String, Object> guistate = WheelAbilitiesSandMenu.guistate;
	...
	ImageButton imagebutton_sand_jet;
	ImageButton imagebutton_burial;
	ImageButton imagebutton_sandstorm;
	...
	public void init() {
		...
		imagebutton_wheel_button_1 = new ImageButton(this.leftPos + 140, this.topPos + 154, 10, 7, 0, 0, 7, new ResourceLocation("power:textures/screens/atlas/imagebutton_wheel_button_1.png"), 10, 14, e -> {
			if (GetWheelTwoOrFirstFakeProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(0, x, y, z));
		...
		imagebutton_wheel_button_2 = new ImageButton(this.leftPos + 152, this.topPos + 154, 10, 7, 0, 0, 7, new ResourceLocation("power:textures/screens/atlas/imagebutton_wheel_button_2.png"), 10, 14, e -> {
			if (GetWheelTwoProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(1, x, y, z));
		...
		imagebutton_wheel_button_3 = new ImageButton(this.leftPos + 164, this.topPos + 154, 10, 7, 0, 0, 7, new ResourceLocation("power:textures/screens/atlas/imagebutton_wheel_button_3.png"), 10, 14, e -> {
			if (GetWheelThreeProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(2, x, y, z));
		...
		imagebutton_fake_wheel_button_1 = new ImageButton(this.leftPos + 140, this.topPos + 164, 10, 7, 0, 0, 7, new ResourceLocation("power:textures/screens/atlas/imagebutton_fake_wheel_button_1.png"), 10, 14, e -> {
			if (GetFakeWheelOneProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(3, x, y, z));
		...
		imagebutton_fake_wheel_button_2 = new ImageButton(this.leftPos + 152, this.topPos + 164, 10, 7, 0, 0, 7, new ResourceLocation("power:textures/screens/atlas/imagebutton_fake_wheel_button_2.png"), 10, 14, e -> {
			if (GetFakeWheelTwoProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(4, x, y, z));
		...
		imagebutton_fake_wheel_button_3 = new ImageButton(this.leftPos + 164, this.topPos + 164, 10, 7, 0, 0, 7, new ResourceLocation("power:textures/screens/atlas/imagebutton_fake_wheel_button_3.png"), 10, 14, e -> {
			if (GetFakeWheelThirdProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(5, x, y, z));
		...
		imagebutton_sand_jet = new ImageButton(this.leftPos + 72, this.topPos + 12, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_sand_jet.png"), 46, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(6, x, y, z));
		...
		guistate.put("button:imagebutton_sand_jet", imagebutton_sand_jet);
		this.addRenderableWidget(imagebutton_sand_jet);
		imagebutton_burial = new ImageButton(this.leftPos + 133, this.topPos + 73, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_burial.png"), 46, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(7, x, y, z));
		...
		guistate.put("button:imagebutton_burial", imagebutton_burial);
		this.addRenderableWidget(imagebutton_burial);
		imagebutton_sandstorm = new ImageButton(this.leftPos + 72, this.topPos + 134, 46, 46, 0, 0, 46, new ResourceLocation("power:textures/screens/atlas/imagebutton_sandstorm.png"), 46, 92, e -> {
			if (PowerLockCheckProcedure.execute(entity)) {
				PowerMod.PACKET_HANDLER.sendToServer(new WheelAbilitiesSandButtonMessage(8, x, y, z));
		...
		guistate.put("button:imagebutton_sandstorm", imagebutton_sandstorm);
