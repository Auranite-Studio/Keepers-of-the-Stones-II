...
public class PoisonDropProjectileRenderer extends EntityRenderer<PoisonDropProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(PoisonDropProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
