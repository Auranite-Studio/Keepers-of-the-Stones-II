...
public class SoundBombProjectileRenderer extends EntityRenderer<SoundBombProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(SoundBombProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
