...
public class SmokeMusketProjectileRenderer extends EntityRenderer<SmokeMusketProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/smoke_musket_projectile.png");
	...
	@Override
	public void extractRenderState(SmokeMusketProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
