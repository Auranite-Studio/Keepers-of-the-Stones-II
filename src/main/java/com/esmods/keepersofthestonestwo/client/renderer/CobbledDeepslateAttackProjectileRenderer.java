...
public class CobbledDeepslateAttackProjectileRenderer extends EntityRenderer<CobbledDeepslateAttackProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/cobbled_deepslate_attack.png");
	...
	@Override
	public void extractRenderState(CobbledDeepslateAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
