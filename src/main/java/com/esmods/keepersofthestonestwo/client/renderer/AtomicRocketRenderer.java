...
public class AtomicRocketRenderer extends EntityRenderer<AtomicRocketEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(AtomicRocketEntity entity, LivingEntityRenderState state, float partialTicks) {
