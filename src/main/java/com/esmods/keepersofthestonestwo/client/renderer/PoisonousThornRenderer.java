...
public class PoisonousThornRenderer extends EntityRenderer<PoisonousThornEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(PoisonousThornEntity entity, LivingEntityRenderState state, float partialTicks) {
