...
public class EtherAttackProjectileRenderer extends EntityRenderer<EtherAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(EtherAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
