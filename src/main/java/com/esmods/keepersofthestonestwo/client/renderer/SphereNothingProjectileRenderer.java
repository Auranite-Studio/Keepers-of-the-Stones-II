...
public class SphereNothingProjectileRenderer extends EntityRenderer<SphereNothingProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(SphereNothingProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
