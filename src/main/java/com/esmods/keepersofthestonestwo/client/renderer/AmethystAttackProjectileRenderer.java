...
public class AmethystAttackProjectileRenderer extends EntityRenderer<AmethystAttackProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/amethyst_block_attack.png");
	...
	@Override
	public void extractRenderState(AmethystAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
