...
public class CobblestoneAttackProjectileRenderer extends EntityRenderer<CobblestoneAttackProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/cobblestone_attack.png");
	...
	@Override
	public void extractRenderState(CobblestoneAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
