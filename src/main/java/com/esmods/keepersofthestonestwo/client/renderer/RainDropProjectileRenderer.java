...
public class RainDropProjectileRenderer extends EntityRenderer<RainDropProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(RainDropProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
