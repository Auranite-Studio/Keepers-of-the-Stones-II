...
public class LightballProjectileRenderer extends EntityRenderer<LightballProjectileEntity> {
	...
	@Override
	public void render(LightballProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(LightballProjectileEntity entity) {
		return texture;
	}
}