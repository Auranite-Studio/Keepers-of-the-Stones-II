...
public class LightballProjectileRenderer extends EntityRenderer<LightballProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(LightballProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
