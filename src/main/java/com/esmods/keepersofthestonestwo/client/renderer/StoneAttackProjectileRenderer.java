...
public class StoneAttackProjectileRenderer extends EntityRenderer<StoneAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(StoneAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
