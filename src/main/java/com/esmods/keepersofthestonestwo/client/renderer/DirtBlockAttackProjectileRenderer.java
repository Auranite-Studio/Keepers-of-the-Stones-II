...
public class DirtBlockAttackProjectileRenderer extends EntityRenderer<DirtBlockAttackProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/dirt_attack.png");
	...
	@Override
	public void extractRenderState(DirtBlockAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
