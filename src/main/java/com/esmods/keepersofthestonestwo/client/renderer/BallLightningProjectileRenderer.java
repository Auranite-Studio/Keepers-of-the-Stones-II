...
public class BallLightningProjectileRenderer extends EntityRenderer<BallLightningProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(BallLightningProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
