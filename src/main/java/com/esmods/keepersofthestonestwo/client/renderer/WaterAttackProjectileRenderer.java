...
public class WaterAttackProjectileRenderer extends EntityRenderer<WaterAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(WaterAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
