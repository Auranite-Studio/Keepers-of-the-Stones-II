...
public class CopperAttackProjectileRenderer extends EntityRenderer<CopperAttackProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/copper_attack.png");
	...
	@Override
	public void extractRenderState(CopperAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
