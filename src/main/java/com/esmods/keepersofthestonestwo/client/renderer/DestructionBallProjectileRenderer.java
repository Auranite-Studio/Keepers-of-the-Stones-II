...
public class DestructionBallProjectileRenderer extends EntityRenderer<DestructionBallProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(DestructionBallProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
