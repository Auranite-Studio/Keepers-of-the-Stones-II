...
public class ExampleMasterRenderer extends HumanoidMobRenderer<ExampleMasterEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private ExampleMasterEntity entity = null;
	...
	@Override
	public void extractRenderState(ExampleMasterEntity entity, HumanoidRenderState state, float partialTicks) {
