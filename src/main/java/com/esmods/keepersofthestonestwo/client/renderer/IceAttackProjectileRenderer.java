...
public class IceAttackProjectileRenderer extends EntityRenderer<IceAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(IceAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
