...
public class MeteoriteProjectileRenderer extends EntityRenderer<MeteoriteProjectileEntity> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/meteorite.png");
	private final Modelmeteorite model;

	public MeteoriteProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelmeteorite(context.bakeLayer(Modelmeteorite.LAYER_LOCATION));
	}

	@Override
	public void render(MeteoriteProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(MeteoriteProjectileEntity entity) {
		return texture;
	}
}