...
public class MeteoriteProjectileRenderer extends EntityRenderer<MeteoriteProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(MeteoriteProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
