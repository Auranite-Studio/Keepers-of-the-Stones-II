...
public class GrenadeRenderer extends EntityRenderer<GrenadeEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(GrenadeEntity entity, LivingEntityRenderState state, float partialTicks) {
