...
public class PoisonBombRenderer extends EntityRenderer<PoisonBombEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(PoisonBombEntity entity, LivingEntityRenderState state, float partialTicks) {
