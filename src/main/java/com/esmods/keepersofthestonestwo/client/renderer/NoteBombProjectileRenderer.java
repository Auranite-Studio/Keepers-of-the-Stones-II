...
public class NoteBombProjectileRenderer extends EntityRenderer<NoteBombProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(NoteBombProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
