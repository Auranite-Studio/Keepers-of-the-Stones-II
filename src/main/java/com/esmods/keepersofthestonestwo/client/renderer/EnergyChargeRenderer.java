...
public class EnergyChargeRenderer extends EntityRenderer<EnergyChargeEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(EnergyChargeEntity entity, LivingEntityRenderState state, float partialTicks) {
