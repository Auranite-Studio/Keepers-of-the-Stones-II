...
public class LavaAttackProjectileRenderer extends EntityRenderer<LavaAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(LavaAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
