...
public class LavaAttackProjectileRenderer extends EntityRenderer<LavaAttackProjectileEntity> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/lava_block_attack.png");
	...
	@Override
	public void render(LavaAttackProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(LavaAttackProjectileEntity entity) {
		return texture;
	}
}