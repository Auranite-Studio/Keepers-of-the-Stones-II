...
public class PlagueBombRenderer extends EntityRenderer<PlagueBombEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(PlagueBombEntity entity, LivingEntityRenderState state, float partialTicks) {
