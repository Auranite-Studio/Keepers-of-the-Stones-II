...
public class PlagueBombRenderer extends EntityRenderer<PlagueBombEntity> {
	private static final ResourceLocation texture = ResourceLocation.parse("power:textures/entities/plague_bomb.png");
	...
	@Override
	public void render(PlagueBombEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
