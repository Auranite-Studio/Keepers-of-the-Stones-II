...
public class GrassBlockAttackProjectileRenderer extends EntityRenderer<GrassBlockAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(GrassBlockAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
