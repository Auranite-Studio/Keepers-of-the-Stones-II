...
public class GoldAttackProjectileRenderer extends EntityRenderer<GoldAttackProjectileEntity> {
	...
	@Override
	public void render(GoldAttackProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(GoldAttackProjectileEntity entity) {
		return texture;
	}
}
