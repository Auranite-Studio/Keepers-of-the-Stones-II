...
public class GoldAttackProjectileRenderer extends EntityRenderer<GoldAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(GoldAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
