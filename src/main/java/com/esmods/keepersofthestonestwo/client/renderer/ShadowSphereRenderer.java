...
public class ShadowSphereRenderer extends EntityRenderer<ShadowSphereEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(ShadowSphereEntity entity, LivingEntityRenderState state, float partialTicks) {
