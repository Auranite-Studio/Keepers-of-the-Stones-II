...
public class IronAttackProjectileRenderer extends EntityRenderer<IronAttackProjectileEntity, LivingEntityRenderState> {
	...
	@Override
	public void extractRenderState(IronAttackProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
