...
public class PlagueParticleTwoParticle extends TextureSheetParticle {
	...
	public static class PlagueParticleTwoParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public PlagueParticleTwoParticleProvider(SpriteSet spriteSet) {
	...
	protected PlagueParticleTwoParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
		this.setSize(1f, 1f);
		this.lifetime = 20;
