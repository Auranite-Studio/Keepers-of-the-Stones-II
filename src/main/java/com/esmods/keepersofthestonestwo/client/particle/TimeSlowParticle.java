...
public class TimeSlowParticle extends TextureSheetParticle {
	...
	public static class TimeSlowParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public TimeSlowParticleProvider(SpriteSet spriteSet) {
	...
	protected TimeSlowParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
		this.setSize(1f, 1f);
		this.lifetime = 18;
