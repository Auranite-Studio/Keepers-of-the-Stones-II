...
public class PoisonParticleParticle extends TextureSheetParticle {
	...
	public static class PoisonParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public PoisonParticleParticleProvider(SpriteSet spriteSet) {
	...
	protected PoisonParticleParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
		this.setSize(1f, 1f);
		this.lifetime = 24;
