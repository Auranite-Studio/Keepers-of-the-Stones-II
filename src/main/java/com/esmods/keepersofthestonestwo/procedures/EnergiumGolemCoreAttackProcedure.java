...
public class EnergiumGolemCoreAttackProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getDoubleOr("IA", 0) > 5 && entity.getPersistentData().getDoubleOr("IA", 0) < 20) {
			entity.getPersistentData().putDouble("BreathRange", (entity.getPersistentData().getDoubleOr("BreathRange", 0) + 1));
		}
		if (entity.getPersistentData().getDoubleOr("IA", 0) > 24 && entity.getPersistentData().getDoubleOr("IA", 0) < 37) {
			if (entity.getPersistentData().getDoubleOr("IA", 0) > 24 && entity.getPersistentData().getDoubleOr("IA", 0) < 26) {
			...
			for (int index0 = 0; index0 < (int) entity.getPersistentData().getDoubleOr("BreathRange", 0); index0++) {
		...
		if (entity.getPersistentData().getDoubleOr("IA", 0) == 42) {
