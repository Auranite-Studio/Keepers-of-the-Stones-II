							...
							if (!(entityiterator == entity)) {
								if (!(entityiterator instanceof LivingEntity _livEnt19 && _livEnt19.isBlocking())) {
									...
									if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof ShieldItem) {
										...
										if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().getDouble("shieldDamageCooldown") >= 10) {
											{
										...
										if ((entityiterator instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getOrCreateTag().getDouble("shieldDamageCooldown") >= 10) {
											{
