...
@EventBusSubscriber
public class RuneAbilitiesActivateProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getData(PowerModVariables.PLAYER_VARIABLES).rune_ability_activate) {
			...
			{
				PowerModVariables.PlayerVariables _vars = entity.getData(PowerModVariables.PLAYER_VARIABLES);
				_vars.rune_ability_activate = false;
				_vars.markSyncDirty();
			}
		}
	}
