...
public class TeleportationElementGetProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!PowerModVariables.MapVariables.get(world).teleportation_stone || !PowerConfigConfiguration.LIMIT_NUMBER_STONES.get()) {
