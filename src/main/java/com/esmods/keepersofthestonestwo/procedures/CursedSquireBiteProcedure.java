...
public class CursedSquireBiteProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double ZPar = 0;
		Range = 0.25;
		if ((entity instanceof CursedSquireEntity _datEntI ? _datEntI.getEntityData().get(CursedSquireEntity.DATA_IA) : 0) == 0) {
			...
			if (entity instanceof CursedSquireEntity _datEntSetI)
				_datEntSetI.getEntityData().set(CursedSquireEntity.DATA_Look, (int) entity.getYRot());
		}
		if (entity instanceof CursedSquireEntity _datEntSetI)
		...
		{
			Entity _ent = entity;
			_ent.setYRot((float) (entity instanceof CursedSquireEntity _datEntI ? _datEntI.getEntityData().get(CursedSquireEntity.DATA_Look) : 0));
			_ent.setXRot(0);
		...
		if ((entity instanceof CursedSquireEntity _datEntI ? _datEntI.getEntityData().get(CursedSquireEntity.DATA_IA) : 0) == 3) {
		...
		if ((entity instanceof CursedSquireEntity _datEntI ? _datEntI.getEntityData().get(CursedSquireEntity.DATA_IA) : 0) > 6 && (entity instanceof CursedSquireEntity _datEntI ? _datEntI.getEntityData().get(CursedSquireEntity.DATA_IA) : 0) < 9) {
		...
		if ((entity instanceof CursedSquireEntity _datEntI ? _datEntI.getEntityData().get(CursedSquireEntity.DATA_IA) : 0) == 12) {
			if (entity instanceof CursedSquireEntity _datEntSetI)
