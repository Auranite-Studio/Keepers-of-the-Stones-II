...
public class EnergiumVaultTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "Opened") != 0) {
			...
			if ((PowerModBlocks.ENERGIUM_VAULT.get().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip3 ? PowerModBlocks.ENERGIUM_VAULT.get().defaultBlockState().getValue(_getip3) : -1) != 2) {
				if (world instanceof Level _level) {
			...
			if (!(!world.getEntitiesOfClass(Player.class, new AABB(Vec3.ZERO, Vec3.ZERO).move(new Vec3(x, y, z)).inflate(5 / 2d), e -> true).isEmpty())
				...
				if ((PowerModBlocks.ENERGIUM_VAULT.get().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip12 ? PowerModBlocks.ENERGIUM_VAULT.get().defaultBlockState().getValue(_getip12) : -1) != 0) {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
				...
				if ((PowerModBlocks.ENERGIUM_VAULT.get().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip15 ? PowerModBlocks.ENERGIUM_VAULT.get().defaultBlockState().getValue(_getip15) : -1) != 1) {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
		...
		if ((PowerModBlocks.ENERGIUM_VAULT.get().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip18 ? PowerModBlocks.ENERGIUM_VAULT.get().defaultBlockState().getValue(_getip18) : -1) == 1
				|| (PowerModBlocks.ENERGIUM_VAULT.get().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip19 ? PowerModBlocks.ENERGIUM_VAULT.get().defaultBlockState().getValue(_getip19) : -1) == 2) {
