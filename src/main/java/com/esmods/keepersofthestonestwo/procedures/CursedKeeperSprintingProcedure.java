...
public class CursedKeeperSprintingProcedure {
	public static boolean execute(Entity entity) {
		if (entity == null)
			return false;
		return entity.isSprinting() && entity.getDeltaMovement().horizontalDistanceSqr() > 1.0E-6D && (entity instanceof CursedKeeperEntity _datEntL2 && _datEntL2.getEntityData().get(CursedKeeperEntity.DATA_stage_one_anim_sync)) == false
