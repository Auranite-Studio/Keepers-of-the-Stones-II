...
public class RenderSpecialFogInCursedBiomesProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (world.getBiome(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ())).is(TagKey.create(Registries.BIOME, new ResourceLocation("power:cursed_biomes"))) && !entity.isUnderWater()
				&& !(entity instanceof LivingEntity _livEnt5 && _livEnt5.hasEffect(PowerModMobEffects.MIST.get()))) {
			setDistance(15, 45);
