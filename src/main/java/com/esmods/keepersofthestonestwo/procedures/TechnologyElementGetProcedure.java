...
public class TechnologyElementGetProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!PowerModVariables.MapVariables.get(world).technology_stone || !PowerConfigConfiguration.LIMIT_NUMBER_STONES.get()) {
