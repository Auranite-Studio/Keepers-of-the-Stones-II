...
public class CobblestoneAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public CobblestoneAttackProjectileEntity(EntityType<? extends CobblestoneAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public CobblestoneAttackProjectileEntity(EntityType<? extends CobblestoneAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static CobblestoneAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		CobblestoneAttackProjectileEntity entityarrow = new CobblestoneAttackProjectileEntity(PowerModEntities.COBBLESTONE_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static CobblestoneAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		CobblestoneAttackProjectileEntity entityarrow = new CobblestoneAttackProjectileEntity(PowerModEntities.COBBLESTONE_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
