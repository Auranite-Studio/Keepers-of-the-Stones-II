...
public class EtherAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public EtherAttackProjectileEntity(EntityType<? extends EtherAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public EtherAttackProjectileEntity(EntityType<? extends EtherAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static EtherAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EtherAttackProjectileEntity entityarrow = new EtherAttackProjectileEntity(PowerModEntities.ETHER_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static EtherAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		EtherAttackProjectileEntity entityarrow = new EtherAttackProjectileEntity(PowerModEntities.ETHER_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
