...
import com.esmods.keepersofthestonestwo.procedures.AmethystAttackProjectileKoghdaSnariadPopadaietVBlokProcedure;
import com.esmods.keepersofthestonestwo.init.PowerModEntities;

@OnlyIn(value = Dist.CLIENT, _interface = ItemSupplier.class)
public class AmethystAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.AMETHYST_BLOCK);

	public AmethystAttackProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(PowerModEntities.AMETHYST_ATTACK_PROJECTILE.get(), world);
	}

	public AmethystAttackProjectileEntity(EntityType<? extends AmethystAttackProjectileEntity> type, Level world) {
		super(type, world);
	}

	public AmethystAttackProjectileEntity(EntityType<? extends AmethystAttackProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public AmethystAttackProjectileEntity(EntityType<? extends AmethystAttackProjectileEntity> type, LivingEntity entity, Level world) {
	...
	public static AmethystAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AmethystAttackProjectileEntity entityarrow = new AmethystAttackProjectileEntity(PowerModEntities.AMETHYST_ATTACK_PROJECTILE.get(), entity, world);
	...
	public static AmethystAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AmethystAttackProjectileEntity entityarrow = new AmethystAttackProjectileEntity(PowerModEntities.AMETHYST_ATTACK_PROJECTILE.get(), entity, entity.level());
