...
public class AmethystAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public AmethystAttackProjectileEntity(EntityType<? extends AmethystAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public AmethystAttackProjectileEntity(EntityType<? extends AmethystAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static AmethystAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AmethystAttackProjectileEntity entityarrow = new AmethystAttackProjectileEntity(PowerModEntities.AMETHYST_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static AmethystAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AmethystAttackProjectileEntity entityarrow = new AmethystAttackProjectileEntity(PowerModEntities.AMETHYST_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
