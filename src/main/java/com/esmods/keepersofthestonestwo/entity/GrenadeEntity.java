...
import com.esmods.keepersofthestonestwo.procedures.LiitleExplosionProcedure;
...
public class GrenadeEntity extends AbstractArrow implements ItemSupplier {
	...
	public GrenadeEntity(EntityType<? extends GrenadeEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public GrenadeEntity(EntityType<? extends GrenadeEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static GrenadeEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		GrenadeEntity entityarrow = new GrenadeEntity(PowerModEntities.GRENADE.get(), entity, world, null);
	...
	public static GrenadeEntity shoot(LivingEntity entity, LivingEntity target) {
		GrenadeEntity entityarrow = new GrenadeEntity(PowerModEntities.GRENADE.get(), entity, entity.level(), null);
