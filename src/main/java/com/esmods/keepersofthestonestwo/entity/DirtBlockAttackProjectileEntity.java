...
public class DirtBlockAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public DirtBlockAttackProjectileEntity(EntityType<? extends DirtBlockAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public DirtBlockAttackProjectileEntity(EntityType<? extends DirtBlockAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static DirtBlockAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		DirtBlockAttackProjectileEntity entityarrow = new DirtBlockAttackProjectileEntity(PowerModEntities.DIRT_BLOCK_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static DirtBlockAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		DirtBlockAttackProjectileEntity entityarrow = new DirtBlockAttackProjectileEntity(PowerModEntities.DIRT_BLOCK_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
