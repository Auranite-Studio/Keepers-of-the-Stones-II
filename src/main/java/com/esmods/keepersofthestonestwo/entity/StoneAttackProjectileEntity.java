...
import com.esmods.keepersofthestonestwo.procedures.StoneAttackKoghdaSnariadPopadaietVBlokProcedure;
...
public class StoneAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public StoneAttackProjectileEntity(EntityType<? extends StoneAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public StoneAttackProjectileEntity(EntityType<? extends StoneAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static StoneAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		StoneAttackProjectileEntity entityarrow = new StoneAttackProjectileEntity(PowerModEntities.STONE_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static StoneAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		StoneAttackProjectileEntity entityarrow = new StoneAttackProjectileEntity(PowerModEntities.STONE_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
