...
import com.esmods.keepersofthestonestwo.procedures.BlueMagnetSetTimerProcedure;
...
public class BlueMagnetEntity extends PathfinderMob {
	public static final EntityDataAccessor<Integer> DATA_time = SynchedEntityData.defineId(BlueMagnetEntity.class, EntityDataSerializers.INT);
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("power:magnetic_waves"));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		...
		BlueMagnetSetTimerProcedure.execute(this);
		return retval;
	}
	...
	public void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.putInt("Datatime", this.entityData.get(DATA_time));
	}

	@Override
	public void readAdditionalSaveData(ValueInput valueInput) {
		super.readAdditionalSaveData(valueInput);
		this.entityData.set(DATA_time, valueInput.getIntOr("Datatime", 0));
	}

	@Override
	public void baseTick() {
		super.baseTick();
		BlueMagnetPriObnovlieniiTikaSushchnostiProcedure.execute(this.level(), this);
	}
