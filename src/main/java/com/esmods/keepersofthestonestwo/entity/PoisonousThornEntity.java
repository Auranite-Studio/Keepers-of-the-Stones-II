...
public class PoisonousThornEntity extends AbstractArrow implements ItemSupplier {
	...
	public PoisonousThornEntity(EntityType<? extends PoisonousThornEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public PoisonousThornEntity(EntityType<? extends PoisonousThornEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(Blocks.ROSE_BUSH);
	}
	...
	public static PoisonousThornEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PoisonousThornEntity entityarrow = new PoisonousThornEntity(PowerModEntities.POISONOUS_THORN.get(), entity, world, null);
	...
	public static PoisonousThornEntity shoot(LivingEntity entity, LivingEntity target) {
		PoisonousThornEntity entityarrow = new PoisonousThornEntity(PowerModEntities.POISONOUS_THORN.get(), entity, entity.level(), null);
