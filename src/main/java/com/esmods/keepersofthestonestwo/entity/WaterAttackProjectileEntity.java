...
public class WaterAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public WaterAttackProjectileEntity(EntityType<? extends WaterAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public WaterAttackProjectileEntity(EntityType<? extends WaterAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static WaterAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		WaterAttackProjectileEntity entityarrow = new WaterAttackProjectileEntity(PowerModEntities.WATER_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static WaterAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		WaterAttackProjectileEntity entityarrow = new WaterAttackProjectileEntity(PowerModEntities.WATER_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
