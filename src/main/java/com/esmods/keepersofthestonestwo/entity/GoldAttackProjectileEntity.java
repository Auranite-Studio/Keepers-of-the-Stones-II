...
public class GoldAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public GoldAttackProjectileEntity(EntityType<? extends GoldAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public GoldAttackProjectileEntity(EntityType<? extends GoldAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static GoldAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 0.8f, 5, 4);
	}
	...
	public static GoldAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		GoldAttackProjectileEntity entityarrow = new GoldAttackProjectileEntity(PowerModEntities.GOLD_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static GoldAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		GoldAttackProjectileEntity entityarrow = new GoldAttackProjectileEntity(PowerModEntities.GOLD_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
