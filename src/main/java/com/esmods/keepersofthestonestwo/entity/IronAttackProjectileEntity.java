...
public class IronAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public IronAttackProjectileEntity(EntityType<? extends IronAttackProjectileEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public IronAttackProjectileEntity(EntityType<? extends IronAttackProjectileEntity> type, LivingEntity entity, Level world) {
