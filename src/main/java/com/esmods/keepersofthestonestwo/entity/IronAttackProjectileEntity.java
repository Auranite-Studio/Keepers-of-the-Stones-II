...
public class IronAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public IronAttackProjectileEntity(EntityType<? extends IronAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public IronAttackProjectileEntity(EntityType<? extends IronAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		IronAttackProjectileKoghdaSnariadPopadaietVBlokProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		IronAttackProjectileKoghdaSnariadPopadaietVBlokProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static IronAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		IronAttackProjectileEntity entityarrow = new IronAttackProjectileEntity(PowerModEntities.IRON_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static IronAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		IronAttackProjectileEntity entityarrow = new IronAttackProjectileEntity(PowerModEntities.IRON_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
