...
public class PlagueBombEntity extends AbstractArrow implements ItemSupplier {
	...
	public PlagueBombEntity(EntityType<? extends PlagueBombEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public PlagueBombEntity(EntityType<? extends PlagueBombEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static PlagueBombEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PlagueBombEntity entityarrow = new PlagueBombEntity(PowerModEntities.PLAGUE_BOMB.get(), entity, world, null);
	...
	public static PlagueBombEntity shoot(LivingEntity entity, LivingEntity target) {
		PlagueBombEntity entityarrow = new PlagueBombEntity(PowerModEntities.PLAGUE_BOMB.get(), entity, entity.level(), null);
