...
public class EnergyChargeEntity extends AbstractArrow implements ItemSupplier {
	...
	public EnergyChargeEntity(EntityType<? extends EnergyChargeEntity> type, Level world) {
		super(type, world);
	}

	public EnergyChargeEntity(EntityType<? extends EnergyChargeEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public EnergyChargeEntity(EntityType<? extends EnergyChargeEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static EnergyChargeEntity shoot(Level world, LivingEntity entity, RandomSource source) {
	...
	public static EnergyChargeEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EnergyChargeEntity entityarrow = new EnergyChargeEntity(PowerModEntities.ENERGY_CHARGE.get(), entity, world, null);
	...
	public static EnergyChargeEntity shoot(LivingEntity entity, LivingEntity target) {
		EnergyChargeEntity entityarrow = new EnergyChargeEntity(PowerModEntities.ENERGY_CHARGE.get(), entity, entity.level(), null);
