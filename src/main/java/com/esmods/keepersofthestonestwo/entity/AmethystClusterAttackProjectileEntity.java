...
public class AmethystClusterAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.AMETHYST_CLUSTER);
	private int knockback = 0;

	public AmethystClusterAttackProjectileEntity(EntityType<? extends AmethystClusterAttackProjectileEntity> type, Level world) {
		super(type, world);
	}

	public AmethystClusterAttackProjectileEntity(EntityType<? extends AmethystClusterAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public AmethystClusterAttackProjectileEntity(EntityType<? extends AmethystClusterAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static AmethystClusterAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AmethystClusterAttackProjectileEntity entityarrow = new AmethystClusterAttackProjectileEntity(PowerModEntities.AMETHYST_CLUSTER_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static AmethystClusterAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AmethystClusterAttackProjectileEntity entityarrow = new AmethystClusterAttackProjectileEntity(PowerModEntities.AMETHYST_CLUSTER_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
