...
import com.esmods.keepersofthestonestwo.procedures.CobbledDeepslateAttackKoghdaSnariadPopadaietVBlokProcedure;
import com.esmods.keepersofthestonestwo.init.PowerModEntities;

public class CobbledDeepslateAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.COBBLED_DEEPSLATE);
	private int knockback = 0;

	public CobbledDeepslateAttackProjectileEntity(EntityType<? extends CobbledDeepslateAttackProjectileEntity> type, Level world) {
		super(type, world);
	}

	public CobbledDeepslateAttackProjectileEntity(EntityType<? extends CobbledDeepslateAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public CobbledDeepslateAttackProjectileEntity(EntityType<? extends CobbledDeepslateAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static CobbledDeepslateAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
	...
	public static CobbledDeepslateAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		CobbledDeepslateAttackProjectileEntity entityarrow = new CobbledDeepslateAttackProjectileEntity(PowerModEntities.COBBLED_DEEPSLATE_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static CobbledDeepslateAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		CobbledDeepslateAttackProjectileEntity entityarrow = new CobbledDeepslateAttackProjectileEntity(PowerModEntities.COBBLED_DEEPSLATE_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
