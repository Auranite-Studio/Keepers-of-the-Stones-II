...
public class BlackHoleEntity extends PathfinderMob {
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("block.respawn_anchor.ambient"));
	}
	...
	public void baseTick() {
		super.baseTick();
		BlackHolePriObnovlieniiTikaSushchnostiProcedure.execute(this.level(), this);
	}
