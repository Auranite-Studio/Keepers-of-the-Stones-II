...
public class KnifeAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public KnifeAttackProjectileEntity(EntityType<? extends KnifeAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public KnifeAttackProjectileEntity(EntityType<? extends KnifeAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static KnifeAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		KnifeAttackProjectileEntity entityarrow = new KnifeAttackProjectileEntity(PowerModEntities.KNIFE_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static KnifeAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		KnifeAttackProjectileEntity entityarrow = new KnifeAttackProjectileEntity(PowerModEntities.KNIFE_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
