...
public class PoisonBombEntity extends AbstractArrow implements ItemSupplier {
	...
	public PoisonBombEntity(EntityType<? extends PoisonBombEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public PoisonBombEntity(EntityType<? extends PoisonBombEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static PoisonBombEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PoisonBombEntity entityarrow = new PoisonBombEntity(PowerModEntities.POISON_BOMB.get(), entity, world, null);
	...
	public static PoisonBombEntity shoot(LivingEntity entity, LivingEntity target) {
		PoisonBombEntity entityarrow = new PoisonBombEntity(PowerModEntities.POISON_BOMB.get(), entity, entity.level(), null);
