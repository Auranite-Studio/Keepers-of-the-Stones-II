...
public class LightballProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public LightballProjectileEntity(EntityType<? extends LightballProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public LightballProjectileEntity(EntityType<? extends LightballProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static LightballProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 9, 2);
	}

	public static LightballProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static LightballProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		LightballProjectileEntity entityarrow = new LightballProjectileEntity(PowerModEntities.LIGHTBALL_PROJECTILE.get(), entity, world, null);
	...
	public static LightballProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		LightballProjectileEntity entityarrow = new LightballProjectileEntity(PowerModEntities.LIGHTBALL_PROJECTILE.get(), entity, entity.level(), null);
