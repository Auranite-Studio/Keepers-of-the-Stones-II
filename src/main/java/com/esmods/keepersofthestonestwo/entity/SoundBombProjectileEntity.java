...
public class SoundBombProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public SoundBombProjectileEntity(EntityType<? extends SoundBombProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public SoundBombProjectileEntity(EntityType<? extends SoundBombProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static SoundBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SoundBombProjectileEntity entityarrow = new SoundBombProjectileEntity(PowerModEntities.SOUND_BOMB_PROJECTILE.get(), entity, world, null);
	...
	public static SoundBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		SoundBombProjectileEntity entityarrow = new SoundBombProjectileEntity(PowerModEntities.SOUND_BOMB_PROJECTILE.get(), entity, entity.level(), null);
