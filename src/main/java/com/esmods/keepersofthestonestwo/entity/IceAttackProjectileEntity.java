...
import com.esmods.keepersofthestonestwo.procedures.IceAttackProjectileProjectileHitsBlockProcedure;
...
public class IceAttackProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public IceAttackProjectileEntity(EntityType<? extends IceAttackProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public IceAttackProjectileEntity(EntityType<? extends IceAttackProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static IceAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static IceAttackProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		IceAttackProjectileEntity entityarrow = new IceAttackProjectileEntity(PowerModEntities.ICE_ATTACK_PROJECTILE.get(), entity, world, null);
	...
	public static IceAttackProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		IceAttackProjectileEntity entityarrow = new IceAttackProjectileEntity(PowerModEntities.ICE_ATTACK_PROJECTILE.get(), entity, entity.level(), null);
