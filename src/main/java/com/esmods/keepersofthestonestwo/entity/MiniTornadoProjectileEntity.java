...
public class MiniTornadoProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public MiniTornadoProjectileEntity(EntityType<? extends MiniTornadoProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public MiniTornadoProjectileEntity(EntityType<? extends MiniTornadoProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static MiniTornadoProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		MiniTornadoProjectileEntity entityarrow = new MiniTornadoProjectileEntity(PowerModEntities.MINI_TORNADO_PROJECTILE.get(), entity, world, null);
	...
	public static MiniTornadoProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		MiniTornadoProjectileEntity entityarrow = new MiniTornadoProjectileEntity(PowerModEntities.MINI_TORNADO_PROJECTILE.get(), entity, entity.level(), null);
