...
public class CharacteristicsCardItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		String hoverText = CharacteristicsCardDopolnitielnaiaInformatsiiaProcedure.execute(entity.level(), itemstack);
		if (hoverText != null) {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			serverPlayer.openMenu(new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Characteristics Card");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new CharacteristicsCardGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
