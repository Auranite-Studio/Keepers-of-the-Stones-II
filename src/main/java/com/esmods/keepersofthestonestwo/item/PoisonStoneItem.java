...
import com.esmods.keepersofthestonestwo.procedures.PoisonStoneUseProcedure;
...
public class PoisonStoneItem extends Item {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		PoisonStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
