...
import com.esmods.keepersofthestonestwo.procedures.AnimalsStoneUseProcedure;

public class AnimalsStoneItem extends Item {
	public AnimalsStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		AnimalsStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
