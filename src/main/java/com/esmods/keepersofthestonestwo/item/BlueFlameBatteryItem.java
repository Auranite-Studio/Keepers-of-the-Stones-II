...
public class BlueFlameBatteryItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.power.blue_flame_battery.description_0"));
		list.accept(Component.translatable("item.power.blue_flame_battery.description_1"));
	}
