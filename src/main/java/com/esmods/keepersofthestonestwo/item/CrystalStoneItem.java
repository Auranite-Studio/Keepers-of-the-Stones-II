...
import com.esmods.keepersofthestonestwo.procedures.CrystalStoneUseProcedure;

public class CrystalStoneItem extends Item {
	public CrystalStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		CrystalStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
