...
import com.esmods.keepersofthestonestwo.procedures.AirStoneUseProcedure;

public class AirStoneItem extends Item {
	public AirStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		AirStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
