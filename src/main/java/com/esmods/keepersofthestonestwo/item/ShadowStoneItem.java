...
import com.esmods.keepersofthestonestwo.procedures.ShadowStoneUseProcedure;
...
public class ShadowStoneItem extends Item {
	public ShadowStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		ShadowStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
