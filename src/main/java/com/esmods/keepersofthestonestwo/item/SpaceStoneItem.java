...
import com.esmods.keepersofthestonestwo.procedures.SpaceStoneUseProcedure;
...
public class SpaceStoneItem extends Item {
	public SpaceStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		SpaceStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
