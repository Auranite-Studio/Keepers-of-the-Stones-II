...
public class TimeKhopeshItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 0, 12f, 0, 1, TagKey.create(Registries.ITEM, ResourceLocation.parse("power:time_khopesh_repair_items")), 1);

	public TimeKhopeshItem(Item.Properties properties) {
