...
import com.esmods.keepersofthestonestwo.procedures.AmberStoneUseProcedure;

public class AmberStoneItem extends Item {
	public AmberStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		AmberStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
