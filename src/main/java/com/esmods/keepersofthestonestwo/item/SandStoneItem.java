...
import com.esmods.keepersofthestonestwo.procedures.SandStoneUseProcedure;
...
public class SandStoneItem extends Item {
	public SandStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		SandStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
