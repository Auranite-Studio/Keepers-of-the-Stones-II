...
public class SpinRuneItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.power.spin_rune.description_0"));
		list.accept(Component.translatable("item.power.spin_rune.description_1"));
		list.accept(Component.translatable("item.power.spin_rune.description_2"));
		list.accept(Component.translatable("item.power.spin_rune.description_3"));
		list.accept(Component.translatable("item.power.spin_rune.description_4"));
	}
