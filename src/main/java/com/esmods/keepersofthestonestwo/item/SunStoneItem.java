...
import com.esmods.keepersofthestonestwo.procedures.SunStoneUseProcedure;
...
public class SunStoneItem extends Item {
	public SunStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		SunStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
