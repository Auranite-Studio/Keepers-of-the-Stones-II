...
public class AdditionTimeMasterEffectRune3Item extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.power.addition_time_master_effect_rune_3.description_0"));
		list.add(Component.translatable("item.power.addition_time_master_effect_rune_3.description_1"));
