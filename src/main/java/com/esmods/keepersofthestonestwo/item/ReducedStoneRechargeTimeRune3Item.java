...
public class ReducedStoneRechargeTimeRune3Item extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.power.reduced_stone_recharge_time_rune_3.description_0"));
		list.accept(Component.translatable("item.power.reduced_stone_recharge_time_rune_3.description_1"));
		list.accept(Component.translatable("item.power.reduced_stone_recharge_time_rune_3.description_2"));
		list.accept(Component.translatable("item.power.reduced_stone_recharge_time_rune_3.description_3"));
		list.accept(Component.translatable("item.power.reduced_stone_recharge_time_rune_3.description_4"));
	}
