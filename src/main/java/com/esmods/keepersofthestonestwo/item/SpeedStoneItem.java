...
import com.esmods.keepersofthestonestwo.procedures.SpeedStoneUseProcedure;
...
public class SpeedStoneItem extends Item {
	public SpeedStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		SpeedStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
