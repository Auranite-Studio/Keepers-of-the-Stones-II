...
import com.esmods.keepersofthestonestwo.procedures.OceanStoneUseProcedure;
...
public class OceanStoneItem extends Item {
	public OceanStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		OceanStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
