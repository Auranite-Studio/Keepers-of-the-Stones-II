...
import com.esmods.keepersofthestonestwo.procedures.MoonStoneUseProcedure;
...
public class MoonStoneItem extends Item {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		MoonStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
