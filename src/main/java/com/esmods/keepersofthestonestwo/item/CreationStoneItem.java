...
import com.esmods.keepersofthestonestwo.procedures.CreationStoneUseProcedure;

public class CreationStoneItem extends Item {
	public CreationStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		CreationStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
