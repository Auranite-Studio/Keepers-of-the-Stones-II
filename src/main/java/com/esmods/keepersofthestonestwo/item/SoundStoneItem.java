...
import com.esmods.keepersofthestonestwo.procedures.SoundStoneUseProcedure;
...
public class SoundStoneItem extends Item {
	public SoundStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		SoundStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
