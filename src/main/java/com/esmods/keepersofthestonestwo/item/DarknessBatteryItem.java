...
public class DarknessBatteryItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
		...
		componentConsumer.accept(Component.translatable("item.power.darkness_battery.description_0"));
		componentConsumer.accept(Component.translatable("item.power.darkness_battery.description_1"));
	}
