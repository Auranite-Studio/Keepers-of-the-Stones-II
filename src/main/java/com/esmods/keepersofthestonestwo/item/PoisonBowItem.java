...
public class PoisonBowItem extends Item {
	public PoisonBowItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		PoisonBowKazhdyiTikVInvientarieProcedure.execute(entity);
	}
	...
	public boolean releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				PoisonDropProjectileEntity projectile = PoisonDropProjectileEntity.shoot(world, entity, world.getRandom(), pullingPower);
