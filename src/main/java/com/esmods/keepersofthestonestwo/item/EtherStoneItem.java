...
import com.esmods.keepersofthestonestwo.procedures.EtherStoneUseProcedure;
import com.esmods.keepersofthestonestwo.PowerMod;

public class EtherStoneItem extends Item {
	public EtherStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		EtherStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
