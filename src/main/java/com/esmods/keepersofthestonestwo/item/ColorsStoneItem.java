...
import com.esmods.keepersofthestonestwo.procedures.ColorsStoneUseProcedure;
...
public class ColorsStoneItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ColorsStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
