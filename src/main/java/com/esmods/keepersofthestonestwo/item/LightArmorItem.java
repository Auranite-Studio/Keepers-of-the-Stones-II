...
public abstract class LightArmorItem extends Item {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(37, Map.of(ArmorType.BOOTS, 3, ArmorType.LEGGINGS, 6, ArmorType.CHESTPLATE, 8, ArmorType.HELMET, 3, ArmorType.BODY, 8), 1,
			...
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("power:light_armor")), 1);
	...
	private LightArmorItem(Item.Properties properties) {
		super(properties);
	}
