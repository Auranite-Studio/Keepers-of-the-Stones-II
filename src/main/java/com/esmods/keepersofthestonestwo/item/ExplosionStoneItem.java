...
import com.esmods.keepersofthestonestwo.procedures.ExplosionStoneUseProcedure;

public class ExplosionStoneItem extends Item {
	public ExplosionStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		ExplosionStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
