...
import com.esmods.keepersofthestonestwo.procedures.VacuumStoneUseProcedure;
...
public class VacuumStoneItem extends Item {
	public VacuumStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		VacuumStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
