...
import com.esmods.keepersofthestonestwo.procedures.MusicStoneUseProcedure;
import com.esmods.keepersofthestonestwo.procedures.GetRechargeInfoProcedure;

public class MusicStoneItem extends Item {
	public MusicStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		MusicStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
