...
import com.esmods.keepersofthestonestwo.procedures.EarthStoneUseProcedure;

public class EarthStoneItem extends Item {
	public EarthStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		EarthStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
