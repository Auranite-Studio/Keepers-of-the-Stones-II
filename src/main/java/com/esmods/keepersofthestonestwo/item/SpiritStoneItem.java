...
import com.esmods.keepersofthestonestwo.procedures.SpiritStoneUseProcedure;
...
public class SpiritStoneItem extends Item {
	public SpiritStoneItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		SpiritStoneUseProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
