...
public class AdditionTimeMasterEffectRune1Item extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		list.accept(Component.translatable("item.power.addition_time_master_effect_rune_1.description_0"));
		list.accept(Component.translatable("item.power.addition_time_master_effect_rune_1.description_1"));
		list.accept(Component.translatable("item.power.addition_time_master_effect_rune_1.description_2"));
		list.accept(Component.translatable("item.power.addition_time_master_effect_rune_1.description_3"));
		list.accept(Component.translatable("item.power.addition_time_master_effect_rune_1.description_4"));
	}
