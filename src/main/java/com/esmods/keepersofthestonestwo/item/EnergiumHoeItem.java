...
public class EnergiumHoeItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 778, 10f, 0, 5, TagKey.create(Registries.ITEM, ResourceLocation.parse("power:energium_hoe_repair_items")), 1);

	public EnergiumHoeItem(Item.Properties properties) {
		super(properties.hoe(TOOL_MATERIAL, 0f, -1f));
	}
